...
async function handleAICheck() {
    if (!AI_API_KEY || AI_API_KEY === "__GEMINI_API_KEY_PLACEHOLDER__") {
        displayError("To get AI analysis, please fork <a href='https://github.com/itsluminous/swp-simulator' style='text-decoration-line=underline'>swp-simulator repository</a> and set the AI_API_KEY environment variable to gemini API key.");
